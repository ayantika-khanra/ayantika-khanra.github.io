      ...
      text: |
        ...
        <li style="margin-bottom: 1rem;">
          ...
          <ul style="margin: 0.2rem 0 0 1.2rem; padding-left: 1rem; font-size: 1rem;">
            <li style="margin: 0 0 0.75rem 0;">numpy, pandas, matplotlib, SQLAlchemy, seaborn</li>
        ...
        <li style="margin-bottom: 1rem;">
          ...
          <ul style="margin: 0.2rem 0 0 1.2rem; padding-left: 1rem; font-size: 1rem;">
            <li style="margin: 0 0 0.75rem 0;">XLOOKUP/INDEX-MATCH, Pivot Tables & Pivot Charts</li>
        ...
        <li style="margin-bottom: 1rem;">
          ...
          <ul style="margin: 0.2rem 0 0 1.2rem; padding-left: 1rem; font-size: 1rem;">
            <li style="margin: 0 0 0.75rem 0;">Problem solving</li>
