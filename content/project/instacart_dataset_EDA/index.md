...
- On all days higher product containing orders happen between 10 pm and 1 am. in fri to mon however another peak emerges around 9 am where people place orders with more products in it.{{< /alert >}}





The average basket size ranges between 9–11 products per order.

Friday through Monday see higher-than-average basket sizes, with Sunday peaking as the day with the largest orders.

Across all days, orders containing more products generally occur during late-night hours (10 PM – 1 AM).

Additionally, on Friday to Monday, a second peak appears around 9 AM, indicating that people place larger orders during this morning window as well.