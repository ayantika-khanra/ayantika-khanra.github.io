...
ax=sns.barplot(df, y='count', x='basket_size', width=1.5 )
...
sns.barplot(df, y='count', x='days_since_prior_order')
```
...
- 
- basket sizes range from 1 to 112 with a peak at baskets with 5 products in it
- days since last order peaks at 7 days indicating weekly ordering pattern of a good amount of users. this variable is also capped at a value of 30.
{{< /alert >}}
